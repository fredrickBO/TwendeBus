...
//   @override
//   Widget build(BuildContext context) {
//     // STEP A: Start with the Scaffold and AppBar.
//     return Scaffold(
//       appBar: AppBar(
//         leading: const BackButton(),
//         title: Text("Sign Up", style: AppTextStyles.headline1),
//         centerTitle: false,
//       ),
//       // STEP B: Add the main structure.
//       body: SingleChildScrollView(
//         padding: const EdgeInsets.all(24.0),
//         child: Form(
//           key: _formKey,
...
//               // STEP D: Add the form fields ONE BY ONE.
//               TextFormField(
//                 controller: _firstNameController,
//                 decoration: const InputDecoration(labelText: 'First Name'),
//                 validator: (value) => (value == null || value.isEmpty)
